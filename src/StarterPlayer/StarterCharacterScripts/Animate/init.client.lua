...
local animNames = { 
	idle = 	{	
				{ id = "http://www.roblox.com/asset/?id=7082168845", weight = 10 }
			},
	walk = 	{ 	
				{ id = "http://www.roblox.com/asset/?id=7082322100", weight = 10 } 
			}, 
	run = 	{
				{ id = "http://www.roblox.com/asset/?id=7082322100", weight = 10 } 
			}, 
	swim = 	{
				{ id = "http://www.roblox.com/asset/?id=7091151451", weight = 10 } 
			}, 
	swimidle = 	{
				{ id = "http://www.roblox.com/asset/?id=7092846403", weight = 10 } 
			}, 
	jump = 	{
				{ id = "http://www.roblox.com/asset/?id=7082462766", weight = 10 } 
			}, 
	fall = 	{
				{ id = "http://www.roblox.com/asset/?id=7082557875", weight = 10 } 
			}, 
	climb = {
				{ id = "http://www.roblox.com/asset/?id=7086762254", weight = 10 } 
			}, 
	sit = 	{
				{ id = "http://www.roblox.com/asset/?id=7087339969", weight = 10 } 
			},	
	toolnone = {
				{ id = "http://www.roblox.com/asset/?id=7098184151", weight = 10 } 
			},
	toolslash = {
...
local emoteNames = { wave = false, dance = true, dance2 = true, dance3 = true, laugh = false, cheer = false}
